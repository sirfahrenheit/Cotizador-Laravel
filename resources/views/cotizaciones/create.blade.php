...
<div class="container">
    ...
    <form action="{{ route('cotizaciones.store') }}" method="POST" id="cotizacionForm">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-4 d-flex align-items-end">
                        <button type="button" class="btn btn-primary mt-3 w-100" id="addProductEntry">
                            Añadir Producto
                        </button>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-6 col-sm-4">
                        <label class=" mt-3 form-label">Subtotal:</label><br>
                        <span id="subtotalDisplay" class="fw-bold">0.00</span>
                    </div>
                    <div class="col-6 col-sm-4">
                        <label class="form-label">Total (con descuento):</label><br>
        ...
        <!-- Botón final para guardar la cotización -->
